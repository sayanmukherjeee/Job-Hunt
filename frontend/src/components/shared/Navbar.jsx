...
const Navbar = () => {
  ...
  return (
    <div className="bg-white">
      <div className="flex flex-wrap items-center justify-between w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16">
        <div>
        ...
        <div className="flex items-center gap-4 md:gap-12">
          {/* Menu */}
          <ul className="hidden md:flex font-medium items-center gap-4 sm:gap-5">
          ...
          {!user ? (
            <div className="flex items-center gap-1 sm:gap-2 flex-wrap">
              ...
              <Link to="/signup">
                <Button
                  size="sm"
                  className="text-xs sm:text-sm bg-[#6A38C2] hover:bg-[#5b30a6]"
                >
                  Signup
                </Button>
              </Link>
